...
import quyenvvph20946.fpl.geotech.model.body.PurchaseBody;
import quyenvvph20946.fpl.geotech.model.response.BannerReponse;
import quyenvvph20946.fpl.geotech.model.response.CartReponse;
import quyenvvph20946.fpl.geotech.model.response.CheckStoreResponse;
import quyenvvph20946.fpl.geotech.model.response.CreateProductResponse;
import quyenvvph20946.fpl.geotech.model.response.DetailProductResponse;
import quyenvvph20946.fpl.geotech.model.response.DetailUserReponse;
import quyenvvph20946.fpl.geotech.model.response.InfoResponse;
import quyenvvph20946.fpl.geotech.model.response.ListChatResponse;
import quyenvvph20946.fpl.geotech.model.response.ListCommentResponse;
import quyenvvph20946.fpl.geotech.model.response.ListMessageResponse;
import quyenvvph20946.fpl.geotech.model.response.ListNotifiReponse;
import quyenvvph20946.fpl.geotech.model.response.LoginResponse;
...
import quyenvvph20946.fpl.geotech.model.response.ProductTypeResponse;
import quyenvvph20946.fpl.geotech.model.response.ServerResponse;
import quyenvvph20946.fpl.geotech.model.response.StoreIdResponse;
import quyenvvph20946.fpl.geotech.model.response.statistical.RevenueByMonthResponse;
import quyenvvph20946.fpl.geotech.model.response.statistical.SoldQuantityProductResponse;
import quyenvvph20946.fpl.geotech.model.response.store.DetailBills;
import quyenvvph20946.fpl.geotech.model.response.store.InfoStore;
import quyenvvph20946.fpl.geotech.model.response.store.ResponseBill;
