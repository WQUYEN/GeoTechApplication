package quyenvvph20946.fpl.geoteachapplication.view.model.response.statistical;

import java.util.List;

import quyenvvph20946.fpl.geoteachapplication.view.model.ProductWithSoldQuantity;
